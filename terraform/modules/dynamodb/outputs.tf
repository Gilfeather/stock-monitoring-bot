output "table_arns" {
  ...
  value = {
    ...
    portfolios  = aws_dynamodb_table.portfolios.arn
    holdings    = aws_dynamodb_table.holdings.arn
  }
}
...
output "table_names" {
  ...
  value = {
    ...
    portfolios  = aws_dynamodb_table.portfolios.name
    holdings    = aws_dynamodb_table.holdings.name
  }
}